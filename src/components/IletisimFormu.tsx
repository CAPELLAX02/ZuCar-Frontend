...
const IletisimFormu: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch('https://zucar-backend.onrender.com/contact', {
        method : 'POST',
          ...
          <div className="iletisim-bilgileri">
            <div className="bilgi-kartlari">
              <div className="bilgi-kart">
                ...
                <div className="kart-icerik">
                  <h4>Adres</h4>
                  <p>Örnek Mahallesi, 1234. Sokak No: 56<br />İstanbul / Türkiye</p>
                </div>
              </div>
              ...
              <div className="bilgi-kart">
                ...
                <div className="kart-icerik">
                  <h4>Telefon</h4>
                  <p>+90 532 123 45 67<br />+90 212 345 67 89</p>
                </div>
              </div>
              ...
              <div className="bilgi-kart">
                ...
                <div className="kart-icerik">
                  <h4>E-posta</h4>
                  <p>info@zucar.com<br />destek@zucar.com</p>
                </div>
              </div>
              ...
              <div className="bilgi-kart">
                ...
                <div className="kart-icerik">
                  ...
                  <p>Pazartesi - Cuma: 09:00 - 18:00<br />Cumartesi: 09:00 - 16:00</p>
                </div>
              </div>
            </div>
            ...
            <div className="sosyal-medya-iletisim">
              ...
              <div className="sosyal-buttons">
                <a href="#" className="sosyal-btn whatsapp">
                ...
                <a href="#" className="sosyal-btn instagram">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="#" className="sosyal-btn facebook">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
